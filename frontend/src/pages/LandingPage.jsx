...
import { Monitor, Scale } from "lucide-react";
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-slate-600">
                    Report issues related to computer lab facilities
                  </p>
                </div>
              </div>
            </button>
