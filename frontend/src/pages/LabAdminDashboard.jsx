            ...
            {complaints.map((complaint) => (
              <Card key={complaint.id} className="p-6" data-testid="complaint-card">
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-sm text-slate-500">Lab Number</p>
                    <p className="font-medium text-slate-900" data-testid="complaint-lab">
                ...
                {complaint.photo_base64 && (
                  <div className="mb-4">
                    <p className="text-sm text-slate-500 mb-2">Attached Photo</p>
                    <img
